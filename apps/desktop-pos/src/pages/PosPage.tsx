...
import { Search, Trash2, ShoppingCart, Plus, Minus, PauseCircle, RotateCcw, X } from 'lucide-react';
import { useCartStore, type HeldOrder } from '../stores/cart.store'; // Import type
          ...
          <div className="absolute inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-10">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-full flex flex-col overflow-hidden">
              <div className="p-4 border-b flex justify-between items-center bg-gray-50">
                ...
                <Button variant="ghost" size="icon" onClick={() => setIsRecallOpen(false)}>
                  <X className="w-5 h-5" />
                </Button>
              </div>
                  ...
                  heldOrders.map((order) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 ml-4">
                        <Button size="sm" onClick={() => handleRestore(order.id)}>
                          Restore
                        </Button>
                        <Button
                          size="icon"
